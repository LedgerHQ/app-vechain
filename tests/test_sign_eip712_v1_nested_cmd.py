"""Functional test for EIP-712 v1 clear-sign with nested custom structs.

Uses the canonical Mail/Person example from the EIP-712 specification, which
exercises hash context push/pop on nested struct entry/exit.
"""
import pytest
...
def test_sign_eip712_v1_nested(scenario_navigator: NavigateWithScenario) -> None:
    ...
    with client.sign_eip712_v1(path=PATH):
        scenario_navigator.review_approve(
            test_name="test_sign_eip712_v1_nested",
